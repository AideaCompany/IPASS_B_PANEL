...
const mantenimiento = () => {
  return (
    <Main title={'Certificado de Usuarios'}>
      <div className="mainContainerLogin">
        <div className="containerForm keyContainer" style={{ width: 1200 }}>
          <div className="image_key">
            <img src="/IPASS_R_pages-to-jpg-0003.png" alt="licencia" />
          </div>
          <div className="infoKey">
            <Descriptions column={1} title={'Certificado: 1500 USUARIOS INTERNOS'} bordered>
