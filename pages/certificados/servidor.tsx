...
const mantenimiento = () => {
  return (
    <Main title={'Certificado de Servidor'}>
      <div className="mainContainerLogin">
        <div className="containerForm keyContainer" style={{ width: 1200 }}>
          <div className="image_key">
            <img src="/IPASS_R_pages-to-jpg-0002.png" alt="licencia" />
          </div>
          <div className="infoKey">
            <Descriptions column={1} title={'Certificado: ACCESO A SERVIDOR'} bordered>
